...
import { Search, Eye, AlertTriangle, CheckCircle, Calendar, Plus, Package, PlusCircle, Bell, Phone } from "lucide-react";
...
export default function IncidentesMostrador() {
  ...
  const debeReaparecer = (incidenteId: string) => {
  ...
  const incidentesReparados = incidentesList.filter(i => i.status === 'Reparado');
                ...
                <Card className="mb-6 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 border-red-200 dark:border-red-800">
                  <CardHeader>
                    ...
                    <CardDescription className="text-red-600 dark:text-red-400">
                      {incidentesPorNotificaciones.tresMas.length} casos con 3 o más notificaciones requieren llamada telefónica
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                          ...
                          {incidentesPorNotificaciones.tresMas.map((incidente) => {
                            ...
                            return (
                              ...
                              >
                                <TableCell className="font-medium">{incidente.codigo}</TableCell>
                                <TableCell>{getClienteName(incidente.codigo_cliente)}</TableCell>
                                <TableCell>{getProductDisplayName(incidente.codigo_producto)}</TableCell>
                                <TableCell>
                                  <Badge className="bg-red-600 text-white">
                                    {numNotif} notificaciones
                                  </Badge>
                                </TableCell>
                                <TableCell>
                ...
                <Table>
                  ...
                  <TableBody>
                    {loading ? (
                      ...
                      return i.status === 'Reparado' && matchesSearch && esVisible;
                    }).length === 0 ? (
                      <TableRow>
                        <TableCell colSpan={7} className="text-center">
                        ...
                        .map((incidente) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell>
                                <Badge className={
                                  numNotif === 0 ? "bg-orange-600 text-white" :
                                  numNotif === 1 ? "bg-blue-600 text-white" :
