          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-4">
            ...
            <OutlinedSelect
              ...
              options={[
                ...
                { value: "raiz", label: "Solo raíz" },
                { value: "subcategoria", label: "Solo subcategorías" }
              ]}
            />
            ...
            <OutlinedSelect
              ...
              value={filterPadre}
              onValueChange={setFilterPadre}
              options={[
                { value: "all", label: "Todas las categorías padre" },
                ...categoriasRaiz.map((cat) => ({ value: cat.id.toString(), label: cat.Categoria || "" }))
              ]}
            />
            
            <OutlinedSelect
              label="Subcategorías"
              value={filterConHijos}
              onValueChange={setFilterConHijos}
              options={[
                { value: "all", label: "Todas" },
                { value: "con_hijos", label: "Con subcategorías" },
                { value: "sin_hijos", label: "Sin subcategorías" }
              ]}
            />
            
            {hasActiveFilters && (
              <Button variant="outline" onClick={clearFilters} className="gap-2 h-14">
                <X className="h-4 w-4" />
                Limpiar filtros
              </Button>
            )}
