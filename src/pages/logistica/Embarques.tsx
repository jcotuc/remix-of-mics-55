...
export default function Embarques() {
  ...
  const handleCreateEmbarque = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Error al crear el embarque');
    }
  };
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Gestión de embarques y transporte de equipos
          </p>
        </div>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle>Registrar Nuevo Embarque</DialogTitle>
            </DialogHeader>
            <form onSubmit={handleCreateEmbarque} className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="numero">Número de Embarque *</Label>
                <Input
                  id="numero"
                  placeholder="EMB-001"
        ...
        <CardContent>
          {loading ? (
            <div className="text-center py-8">
              <p className="text-muted-foreground">Cargando embarques...</p>
            </div>
          ) : embarques.length === 0 ? (
