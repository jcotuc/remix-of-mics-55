...
DROP POLICY IF EXISTS "Logistica can view embarques" ON public.embarques;
DROP POLICY IF EXISTS "Logistica can insert embarques" ON public.embarques;
DROP POLICY IF EXISTS "Logistica can update embarques" ON public.embarques;
...
-- Add embarque_id to incidentes table if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
